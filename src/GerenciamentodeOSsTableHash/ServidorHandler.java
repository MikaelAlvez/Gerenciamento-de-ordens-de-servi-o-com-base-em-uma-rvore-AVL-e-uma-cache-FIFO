...
public class ServidorHandler {
    ...
    public ServidorHandler(Servidor servidor) {
    ...
    private void consultarOS() throws Exception {
        ...
        OrdensdeServicos os = servidor.buscarOSCache(codigo);
    ...
    private void listarOS() {
        System.out.println("\n----- Lista de OS -----");
        List<OrdensdeServicos> ordens = servidor.listarOs();
    ...
    private void editarOS() throws Exception {
        ...
        OrdensdeServicos osExistente = servidor.buscarOSCache(codigo);
        ...
        if (osExistente != null) {
            ...
            if (servidor.alterarOS(osExistente)) {
